...
public class ProfileEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgViewProfile = (CircleImageView) findViewById(R.id.imageview_item_image_profile);
        ...
        switch (requestCode){
            case 10:
                if(resultCode==RESULT_OK){
                    ...
                    Picasso.get().load(imgUri).into(imgViewProfile);
    ...
    void saveData(){
        ...
        if(imgUri==null){
            ...
            Toast.makeText(this, "변경할 프로필 사진을 선택하세요", Toast.LENGTH_SHORT).show();
            return;
        }
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                imgRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        profileRef.child(StaticUserInformation.nickName).setValue( uri.toString());
                        Toast.makeText(ProfileEditActivity.this, StaticUserInformation.nickName
                                + "님 프로필 사진 수정 완료", Toast.LENGTH_SHORT).show();
