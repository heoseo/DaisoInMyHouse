...
public class ImageUpload {
    static String serviceDomain = "http://daisoinmyhouse.cafe24.com";
    static String postUrl = serviceDomain + "/uploadImage.jsp";
    static String CRLF = "\r\n";
    ...
    public ImageUpload(String name, String password) {
        this.name = name;
